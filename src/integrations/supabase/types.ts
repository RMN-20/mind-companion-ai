    ...
    Tables: {
      ...
      interventions: {
        Row: {
          ...
          is_active: boolean
          title: string
          trigger_stress_level: number | null
          type: string
          user_id: string
        }
        Insert: {
      ...
      profiles: {
        Row: {
          ...
          preferred_interventions: string[] | null
          updated_at: string
          user_id: string
        }
        Insert: {
      ...
      stress_readings: {
        Row: {
          ...
          typing_error_rate: number | null
          typing_pause_pattern: number | null
          typing_speed: number | null
          typing_stress: number | null
          user_id: string
